...
{
    private const string ConnStr = "server=tma3a.mysql.database.azure.com; port=3306; user=nino@tma3a; password = wsci4X1Tio%@; database=tma3a;";
    //private const string ConnStr = "Database=localdb;Data Source=127.0.0.1;User Id=azure;Password=6#vWHD_$";
    public Connection()
    {
