...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            if (Connection.DoesCustomerExist(tbxUser.Text, tbxPw.Text))
            {
    ...
    protected void btnCreateAccount_Click(object sender, EventArgs e)
    {
        ...
        {
            Connection.AddUserToDatabase(tbxUserCreate.Text, tbxPwCreate.Text);
    ...
    private bool ValidUserCreate()
    {
        ...
        var taken = Connection.IsUsernameTaken(tbxUserCreate.Text);
    ...
    protected void btnLogout_Click(object sender, EventArgs e)
    {
        ...
        ShowBtns(_alreadyLoggedIn);
        loginSignUp.Text = "LOG IN/SIGN UP";
        loginUpdate.Update();
    }
    ...
    protected void btnSaveNewPw_Click(object sender, EventArgs e)
    {
        ...
        if(!string.IsNullOrEmpty(tbxNewPw.Text))
            Connection.SaveNewPassword(loginSignUp.Text, tbxNewPw.Text);
