...
public partial class ProductParts : System.Web.UI.Page
{
    private string User;
    ...
    private void UpdateGui()
    {
        ...
        var comps = Connection.GetAllComponents();
    ...
    {
        var comp = Connection.GetComponent(Int32.Parse(((ImageButton) sender).ID));
    ...
    private void AddCartItem(CartItem item)
    {
        ...
        if (IsUserLoggedIn)
        {
            item.TableRowId = Connection.AddCartItemToOrder(item, User);
