            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-center">
                    <div class="text-left">
                        <h1>Feedback</h1>
                        <hr />
                        <p>Please fill out the form below to submit your Feedback and Review.</p>
                        <ul style="list-style-type: none">
                            <li>
                                <h6>Name:</h6>
                                <asp:TextBox id="tbxName" runat="server" MaxLength="50" placeholder="Full Name" Width="335px" OnTextChanged="tbxName_TextChanged"></asp:TextBox>
                                <asp:Label runat="server" CssClass="text-danger" id="errName"></asp:Label>
                            </li>
                            <hr />
                            <li>
                                <h6>Email:</h6>
                                <asp:TextBox ID="tbxEmail" runat="server" MaxLength="50" placeholder="Email" Width="335px" OnTextChanged="tbxEmail_TextChanged"></asp:TextBox>
                                <asp:Label runat="server" CssClass="text-danger" id="errEmail"></asp:Label>
                            </li>
                            <hr />
                            <li>
                                <h6>Title:</h6>
                                <asp:TextBox ID="tbxSubject" runat="server" MaxLength="100" placeholder="Feedback Title" Width="474px" OnTextChanged="tbxSubject_TextChanged"></asp:TextBox>
                                <asp:Label runat="server" CssClass="text-danger" id="errSubject"></asp:Label>
                            </li>
                            <hr />
                            <li>
                                <h6>Details:</h6>
                                <asp:TextBox ID="tbxDetails" runat="server" placeholder="Write your feedback, reviews or questions over here." Height="191px" TextMode="MultiLine" Width="500px" OnTextChanged="tbxDetails_TextChanged"></asp:TextBox>
                                <asp:Label runat="server" CssClass="text-danger" id="errDetails"></asp:Label>
                            </li>
                            <hr />
                            <li>
                                <asp:Button CssClass="btn btn-secondary text-right" runat="server" Text="Submit Feedback" ID="btnSubmit" OnClick="Submitbtn"/>
                                <asp:Label runat="server" CssClass="text-danger text-right" id="errSubmit"></asp:Label>
                            </li>
                        </ul>
                    </div>
                </div>
