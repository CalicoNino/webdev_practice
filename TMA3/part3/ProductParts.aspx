<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductParts.aspx.cs" Inherits="ProductParts" %>
            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-center">
                    <div class="text-left">
                        ...
                        <ul class="products">
                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/11.png" ID="item_11"/><br/>11 inch. Display ($105.05)</li>
                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/13.png" ID="item_13"/><br/>13 inch. Display ($155.33)</li>
                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/15.png" ID="item_15"/><br/>15 inch. Display ($205.99)</li>

                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/hdd256.png" ID="item_hdd256"/><br/>HDD 256GB ($43.95)</li>
                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/ssd128.png" ID="item_ssd128"/><br/>SSD 128GB ($72.75)</li>
                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/ssd256.png" ID="item_ssd256"/><br/>SSD 256GB ($103.32)</li>
                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/ssd500.png" ID="item_ssd500"/><br/>SSD 500GB ($183.99)</li>
                            <li><asp:ImageButton CssClass="productPartItem" OnClick ="Item_Click" ToolTip="Add to Cart" runat="server" ImageUrl="../shared/img/compparts/ubuntu.png" ID="item_ubuntu"/><br/>Ubuntu 17.10 ($12.65)</li>
                        </ul>
                    </div>
                </div>
