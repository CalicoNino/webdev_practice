                        ...
                        <div class="row content">
                            ...
                            <div class="col-sm-8">
                                <div>
                                    ...
                                    <div id="pwRecovery" class="my-2">
                                        <asp:Button runat="server" Text="Change Password" CssClass="btn btn-warning" ID="btnPwRecovery" OnClick="btnPwRecovery_Click"/>
                                        <br />
                                        <br />
                                        ...
                                        <asp:Button runat="server" Text="Save new password" CssClass="btn btn-secondary" ID="btnSaveNewPw" OnClick="btnSaveNewPw_Click"/>
                                        <asp:Label runat="server" CssClass="text-danger" ID="errNwPw"></asp:Label>
                                    </div>
                                    <asp:Label runat="server" CssClass="text-danger" ID="errLogin"></asp:Label> <br />
                                    ...
                                    <div class="container text-center" style="display: flex; justify-content: center;">                                                                                
                                        <div class="row">
                                            <div class="col-xs-2 bg-dark text-light p-3 rounded m-4 overflow-auto">
                                                <h6>Welcome back!</h6>
                                                <hr />
