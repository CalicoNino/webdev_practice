                ...
                <div class="col-sm-8 text-center">
                    <div>
                        ...
                        <div>
                            ...
                            <ContentTemplate>
                                <div class="bg-dark text-light p-4 m-5 rounded">
                                    <h6>Your Total:</h6>
                                    <asp:Label Font-Size="30px" runat="server" CssClass="font-weight-bold" ID="total"></asp:Label>
                                    <br />
                                    <button class="btn btn-warning m-3" onclick="alert('Your ordered has been placed!')">Place your Order</button>
                                </div>
                                <div id="computerContent" runat="server">
                                </div>
                                </ContentTemplate>
                                </asp:UpdatePanel>
                        </div>
