<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductItem.aspx.cs" Inherits="ProductItem" %>
        ...
        <div class="container-fluid text-center mt-4">
            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-center">
                    <div>
                        <h1 class="text-left">Computer Product</h1>
                        <hr />
                        <asp:Label runat="server" ID="compLbl" Font-Size="30px"></asp:Label>
                        <br />
                        <asp:Label runat="server" ID="totalPrice" Font-Size="15px"></asp:Label>
                        <hr />
                                ...
                                <div class="col-xs-2 bg-warning text-dark p-3 rounded m-4">
                                    ...
                                    <table class="m-auto" >
                                        <tr>
                                            ...
                                            <td class="text-left"><asp:DropDownList runat="server" id="optDisplay" OnSelectedIndexChanged="CalculateTotal" AutoPostBack="True"/></td>
                                        </tr>
                                        <tr>
                                            <td class="text-left font-weight-bold">Drive:</td>
                                            <td class="text-left"><asp:DropDownList runat="server" id="optDrive" OnSelectedIndexChanged="CalculateTotal" AutoPostBack="True"/></td>
                                        </tr>
                                        <tr>
                                            <td class="text-left font-weight-bold">RAM:</td>
                                            <td class="text-left"><asp:DropDownList runat="server" id="optRam" OnSelectedIndexChanged="CalculateTotal" AutoPostBack="True"/></td>
                                        </tr>
                                        <tr>
                                            <td class="text-left font-weight-bold">CPU:</td>
                                            <td class="text-left"><asp:DropDownList runat="server" id="optCpu" OnSelectedIndexChanged="CalculateTotal" AutoPostBack="True"/></td>
                                        </tr>
                                        <tr>
                                            <td class="text-left font-weight-bold">OS:</td>
                                            <td class="text-left"><asp:DropDownList runat="server" id="optOs" OnSelectedIndexChanged="CalculateTotal" AutoPostBack="True"/></td>
                                        </tr>
                                    </table>
                                    <br />
                                    <asp:Button runat="server" Text="Add to Cart" CssClass="btn btn-primary m-auto" ID="btnAddToCart" OnClick="btnAddToCart_Click"/>
                                    <br />
                                </div>
                            </div>
                        </div>
