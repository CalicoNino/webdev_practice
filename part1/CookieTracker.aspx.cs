...
public partial class CookieTracker : System.Web.UI.Page { 
    private const string CookieName = "nbofcookies";
    ...
    private void UpdateGui() {
        ...
        nbCookies.Text = GetCurrentCount(cookie);
        IpAddy.Text = GetClientIpAddr();
    }
    ...
    protected void Refreshbtn(object sender, EventArgs e) {
        //Refresh is automatic at a button click
    }
}